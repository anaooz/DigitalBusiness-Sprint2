...
import main.java.br.com.fiap.doctorchat.exceptions.RestNotFoundException;
import main.java.br.com.fiap.doctorchat.models.Agenda;
import main.java.br.com.fiap.doctorchat.repository.AgendaRepository;
...
public class AgendaController {
    ...
    @GetMapping("{id}")
    @Operation(
        summary = "Detalhar agenda",
        description = "Endpoint que recebe um id e retorna os dados da agenda. O id deve ser ..."
